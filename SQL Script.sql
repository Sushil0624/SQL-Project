...
Create table locations(Location_ID int primary key,Street_Address varchar(50),Postal_Code varchar(15),City varchar(50),
State_Province varchar(20),Country_ID varchar(20));

insert into locations values(1000,'1297 Via Cola di Rie',989,'Roma','Rm','IT'),
(1100,'93091 Calle della Te', 10934, 'Venice','Vn','IT'),
(1200,'2017 Shinjuku-ku',1689,'Tokyo','Tokyo Prefectu','  JP'),
(1300,'9450 Kamiya-cho',6823,'Hiroshima','HR','JP'),
...
(1900,'6092 Boxwood St','YSW 9T2','Whitehorse  Yukon','WH','CA'),
(2000,'40-5-12 Laogianggen ','190518','Beijing','BJ','CN'),
(2100,'1298 Vileparle (E)',490231 ,'Bombay','Maharashtra','IN'),
(2200,'12-98 Victoria Stree','2901','Sydney','New South Wale','AU'),
(2300,'198 Clementi North ','540198','Singapore','SG','SG'),
(2400,'8204 Arthur St','6564','London','LN','UK'),
...
create table Job(Job_ID varchar(50) primary key,Job_Title varchar(70),Min_salary varchar(20),Max_Salary varchar(20));
...
create table department(Department_ID int primary key ,Department_name varchar(30),Manager_ID int,Location_ID int,foreign key(Location_ID)references locations(Location_ID));

insert into department values(10,'Administration',200,1700),(20,'Marketing',201,1800),(30,'Purchasing',114,1700),
 ...
 (210,'IT Support',0,1700),(220,'NOC',0,1700),(230,'IT Helpdesk',0,1700),(240,'Government Sales',0,1700),
 (250,'Retail Sales',0,1700),(260,'Recruiting',0,1700),(270,'Payroll',0,1700);
 
 create table employee(Emp_ID int primary key,First_Name varchar(30),Last_Name varchar(30),
Email varchar(50),phone_number varchar(30),Hire_Date date,Job_ID varchar(50),salary decimal(10,2),
commission_pct decimal(5,2),Manager_ID int,Department_ID int,foreign key (Job_ID) references Job(Job_ID),foreign key(Department_ID) references department(Department_ID));

insert into employee values
(100,'Steven','King','SKING','515.123.4567','2003-06-17','AD_PRES',24000,0.00,0,90),
...
(145,'John','Russell','JRUSSEL','011.44.1344.429268','2004-10-01','SA_MAN',14000,0.40,100,80),
(146,'Karen','Partners','KPARTNER','011.44.1344.467268','2005-01-05','SA_MAN',13500,0.30,100,80),
(147,'Alberto','Errazuriz','AERRAZUR','011.44.1344.429278','2005-03-10','SA_MAN',12000,0.30,100,80),
(148,'Gerald','Cambrault','GCAMBRAU','011.44.1344.619268','2007-10-15','SA_MAN','11000',0.30,100,80),
(149,'Eleni','Zlotkey','EZLOTKEY','011.44.1344.429018','2008-01-29','SA_MAN',10500,0.20,100,80),
(150,'Peter','Tucker','PTUCKER','011.44.1344.129268','2005-01-30','SA_REP','10000',0.30,145,80),
...
(153,'Christopher','Olsen','COLSEN','011.44.1344.498718','2006-03-30','SA_REP',8000,0.20,145,80),
(154,'Nanette','Cambrault','NCAMBRAU','011.44.1344.987668','2006-12-09','SA_REP','7500',0.20,145,80),
...
(159,'Lindsey','Smith','LSMITH','011.44.1345.729268','2005-03-10','SA_REP',8000,0.30,146,80),
...
(179,'Charles','Johnson','CJOHNSON','011.44.1644.429262','2008-01-04','SA_REP',6200,0.10,149,80),
(180,'Winston','Taylor','WTAYLOR','650.507.9876','2006-01-24','SH_CLERK',3200,0.00,120,50),
(181,'Jean','Fleaur','JFLEAUR','650.507.9877','2006-02-23','SH_CLERK',3100,0.00,120,50),
(182,'Martha','Sullivan','MSULLIVA','650.507.9878','2007-06-21','SH_CLERK',2500,0.00,120,50),
(183,'Girard','Geoni','GGEONI','650.507.9879','2008-02-03','SH_CLERK',2800,0.00,120,50),
(184,'Nandita','Sarchand','NSARCHAN','650.509.1876','2004-01-27','SH_CLERK','4200',0.00,121,50),
(185,'Alexis','Bull','ABULL','650.509.2876','2005-02-20','SH_CLERK',4100,0.00,121,50),
(186,'Julia','Dellinger','JDELLING','650.509.3876','2006-06-24','SH_CLERK',3400,0.00,121,50),
(187,'Anthony','Cabrio','ACABRIO','650.509.4876','2007-02-07','SH_CLERK',3000,0.00,121,50),
(188,'Kelly','Chung','KCHUNG','650.505.1876','2005-06-14','SH_CLERK',3800,0.00,122,50),
(189,'Jennifer','Dilly','JDILLY','650.505.2876','2005-08-13','SH_CLERK',3600,0.00,122,50),
(190,'Timothy','Gates','TGATES','650.505.3876','2006-07-11','SH_CLERK',2900,0.00,122,50),
(191,'Randall','Perkins','RPERKINS','650.505.4876','2007-12-19','SH_CLERK',2500,0.00,122,50),
(192,'Sarah','Bell','SBELL','650.501.1876','2004-02-04','SH_CLERK',4000,0.00,123,50),
(193,'Britney','Everett','BEVERETT','650.501.2876','2005-03-03','SH_CLERK',3900,0.00,123,50),
(194,'Samuel','McCain','SMCCAIN','650.501.3876','2006-07-01','SH_CLERK',3200,0.00,123,50),
(195,'Vance','Jones','VJONES','650.501.4876','2007-03-17','SH_CLERK',2800,0.00,123,50),
(196,'Alana','Walsh','AWALSH','650.507.9811','2006-04-24','SH_CLERK',3100,0.00,124,50),
(197,'Kevin','Feeney','KFEENEY','650.507.9822','2006-05-23','SH_CLERK',3000,0.00,124,50),
(198,'Donald','OConnell','DOCONNEL','650.507.9833','2007-06-21','SH_CLERK',2600,0.00,124,50),
(199,'Douglas','Grant','DGRANT','650.507.9844','2008-01-13','SH_CLERK',2600,0.00,124,50),
(200,'Jennifer','Whalen','JWHALEN','515.123.4444','2003-09-17','AD_ASST','4400',0.00,101,10),
(201,'Michael','Hartstein','MHARTSTE','515.123.5555','2004-02-17','MK_MAN',13000,0.00,100,20),
(202,'Pat','Fay','PFAY','603.123.6666','2005-08-17','MK_REP',6000,0.00,201,20),
(203,'Susan','Mavris','SMAVRIS','515.123.7777','2002-06-07','HR_REP',6500,0.00,101,40),
(204,'Hermann','Baer','HBAER','515.123.8888','2002-06-07','PR_REP',10000,0.00,101,70),
(205,'Shelley','Higgins','SHIGGINS','515.123.8080','2002-06-07','AC_MGR','12008',0.00,101,110),
(206,'William','Gietz','WGIETZ','515.123.8181','2002-06-07','AC_ACCOUNT',8300,0.00,205,110);  
